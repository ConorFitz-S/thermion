...
@ffi.Native<
    ffi.Void Function(
        ...
        ffi.Pointer<ffi.Float>,
        ffi.Int)>(isLeaf: true)
external void AnimationManager_getBoneBindTransforms(
  ffi.Pointer<TAnimationManager> tAnimationManager,
  ffi.Pointer<TSceneAsset> sceneAsset,
  int skinIndex,
  ffi.Pointer<ffi.Int32> parentIndices,
  ffi.Pointer<ffi.Float> localRotations,
  ffi.Pointer<ffi.Float> worldRotations,
  int numBones,
);
